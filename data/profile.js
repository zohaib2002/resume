const profileData = {
  ...
  about: {
    ...
    contact: {
      ...
      portfolio: 'https://imvpn22.github.io/'
    }
  },
  links: {
  ...
  education: [
    ...
    {
      alma: 'Jwala Devi SVMIC, Allahabad',
      duration: '2011 - 2013',
  ...
  projects: [
    {
      ...
      desc:
        "Udacity's 'Mobile Web Specialist Restaurant Reviews App' Project for  MWS Nanodegree"
    },
    {
      title: 'WhiteBoard',
  ...
  experiences: [
    {
      desc:
        "<strong>Project Engineer</strong> at  <a target='_blank' href='https://www.wipro.com/'> <strong> Wipro </strong> </a>",
    ...
    {
      desc:
        "<strong>Full-Stack Developer intern</strong> at  <a target='_blank' href='https://www.venuemonk.com/'> <strong> Venuemonk </strong> </a> (<a target='_blank' href='https://drive.google.com/open?id=1ch_9x9jCp_TJwKY43FG-pCr_zV9H2iun'> https://goo.gl/Uz1gaf</a>)",
      date: 'Jan - Apr 2018',
      details: [
    ...
    {
      desc:
        "<strong>Product development intern</strong> at <a target='_blank' href='https://hasura.io/'> <strong> Hasura </strong> </a> (<a target='_blank' href='https://drive.google.com/file/d/0B6uOcoHYLgJ7UmlrUDlsMkVwajg/view?usp=sharing'> https://goo.gl/8V3jBy</a>)",
      date: 'May - Aug 2017',
      details: [
  ...
  events: [
    {
      ...
      body: [
        {
          desc:
            "<strong>Mobile Web Specialist</strong>, a Nanodegree provided by <a target='_blank' href='https://in.udacity.com//'> <strong>Udacity</strong>  (<a target='_blank' href='https://confirm.udacity.com/RLMHXAWZ'> https://goo.gl/RGRzVn</a>)",
          date: 'May - Nov 2018'
        },
        {
          desc:
            "<a target='_blank' href='https://www.imad.tech'><strong>IMAD</strong></a>, a MOOC provided by <a target='_blank' href='https://onlinecourses.nptel.ac.in/'> <strong>NPTEL</strong> </a> and <a target='_blank' href='https://hasura.io/'> <strong> Hasura</strong> </a> (<a target='_blank' href='http://nptel.ac.in/noc/E_Certificate/linkedin/noc17-cs06/NPTEL17CS0626270067AN.jpg'> https://goo.gl/X3HEdR</a>)",
          date: 'Jan - Mar 2017'
        },
        {
          desc:
            "<strong>ETCS</strong>, a Summer Training provided by <a href='http://www.mnnit.ac.in/' target='_blank'> <strong>MNNIT </strong> Allahabad</a> (<a target='_blank' href='https://drive.google.com/file/d/0B6uOcoHYLgJ7WEVmdlJDcWVZcEE/view?usp=sharing'>Certificate link</a>)",
          date: 'Jun - July 2016'
        }
      ]
    },
    {
      ...
      body: [
        {
          desc:
            "Event Organizer in <strong>Jnanagni'17</strong> (Annual Techno-Cultural fest of FET, GKV)",
          date: 'Mar 2017'
        },
        {
          desc:
